...
export const ORGANIZATIONS: Organization[] = [
    {
        ...
        internalRepositoriesCommits: CHARTJS[3],
        externalRepositoriesPullRequests: CHARTJS[4],
...
export const MEMBERS: Member[] = [
    {
        ...
        amountPreviousCommits: 200,
        amountPreviousPullRequests: 1,
        amountPreviousIssues: 7,
    ...
    },
    {
        ...
        name: 'Peter Müller',
        organization: ORGANIZATIONS[0],
        amountPreviousCommits: 180,
        amountPreviousPullRequests: 3,
        amountPreviousIssues: 11,
        avatarURL: "assets/octocat.jpg",
        githubURL: "github.com/s-gbz",
        previousCommits: CHARTJS[0],
        previousIssues: CHARTJS[1],
    ...
    },
    {
        ...
        name: 'John Doe',
        organization: ORGANIZATIONS[0],
        amountPreviousCommits: 10,
        amountPreviousPullRequests: 14,
        amountPreviousIssues: 0,
        avatarURL: "assets/octocat.jpg",
        githubURL: "github.com/s-gbz",
        previousCommits: CHARTJS[0],
        previousIssues: CHARTJS[1],
    ...
    },
    {
        ...
        organization: ORGANIZATIONS[0],
        amountPreviousCommits: 2,
        amountPreviousPullRequests: 13,
        amountPreviousIssues: 2,
        avatarURL: "assets/octocat.jpg",
        githubURL: "github.com/s-gbz",
        previousCommits: CHARTJS[0],
        previousIssues: CHARTJS[1],
    ...
    },
    {
        ...
        name: 'Peter Pan',
        organization: ORGANIZATIONS[0],
        amountPreviousCommits: 0,
        amountPreviousPullRequests: 7,
        amountPreviousIssues: 5,
        avatarURL: "assets/octocat.jpg",
        githubURL: "github.com/s-gbz",
        previousCommits: CHARTJS[0],
        previousIssues: CHARTJS[1],
    ...
    },
    {
        ...
        name: 'Dennis Zäuner',
        organization: ORGANIZATIONS[0],
        amountPreviousCommits: 20,
        amountPreviousPullRequests: 0,
        amountPreviousIssues: 20,
        avatarURL: "assets/octocat.jpg",
        githubURL: "github.com/s-gbz",
        previousCommits: CHARTJS[0],
        previousIssues: CHARTJS[1],
